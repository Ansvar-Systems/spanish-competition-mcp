...
const TOOLS = [
  {
    ...
    description:
      "Full-text search across CNMC enforcement decisions (abuse of dominance, cartel, sector inquiries). Returns matching decisions with case number, parties, outcome, fine amount, and GWB articles cited.",
    inputSchema: {
  ...
  },
  {
    ...
    description:
      "Get a specific CNMC decision by case number (e.g., 'B6-22/16').",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description:
      "Search CNMC merger control decisions (Fusionskontrolle).",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description:
      "List all sectors with CNMC enforcement activity, including decision and merger counts.",
      ...
      switch (name) {
        ...
        case "es_comp_about": {
          return textContent({
            ...
            version: pkgVersion,
            description:
              "CNMC (German Federal Cartel Office) MCP server. Provides access to German competition law enforcement decisions, merger control cases, and sector enforcement data under the GWB (Gesetz gegen Wettbewerbsbeschränkungen).",
            data_source: "CNMC (https://www.bundeskartellamt.de/)",
